                        ...
                        <div class="tab-pane fade show active about" id="pills-about" role="tabpanel" aria-labelledby="pills-home-tab">
                            <form>
                                <fieldset disabled>
                                    ...
                                    <div class="mb-3">
                                    <label for="disabledTextInput" class="form-label">Name : &emsp; &emsp; {{student.name}}</label>
                                    
                                    </div>
                                    <hr>
                                    <div class="mb-3">
                                    <label for="disabledTextInput" class="form-label">Student ID : &emsp; {{student.id}}</label>
                                    
                                    </div>
                                    <hr>
                                    <div class="mb-3">
                                    <label for="disabledTextInput" class="form-label">Email : &emsp; &emsp; {{student.email}}</label>
